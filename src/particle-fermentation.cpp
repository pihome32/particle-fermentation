...
#line 1 "c:/Users/m.favre.ST12/Documents/Perso/particle-fermentation/src/particle-fermentation.ino"
...
void mainUpdate();
void PIDUpdate();
void RelayHandler(uint8_t gpio,uint8_t state);
...
#line 16 "c:/Users/m.favre.ST12/Documents/Perso/particle-fermentation/src/particle-fermentation.ino"
...
void setup() {
 ...
 // setup the initial PID settings
  ...
  // and webhooks.
    ...
    Particle.function("RelayHandler",RelayHandler); // Change the PID mode for Manual tuning.  
}
...
int webPublish(String x){
   ...
   // ,curBeerTemp,curFridgeTemp,Output,fridgeState[0],fridgeState[1],startTime,mode,Setpoint,profileName.c_str(),profileStart));
    ...
    ,curChamberTemp,curFridgeTemp,Output,fridgeState[0],fridgeState[1],startTime,mode,Setpoint,profileName.c_str(),profileStart));
